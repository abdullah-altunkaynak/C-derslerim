...
/*ÖDEVLER
	-Bitwise operatörlerinin nerelerde kullanýlabileceðini araþtýr.1 **buna söylenecek birþey yok mantýksal iþlem gertektiren heryerde kullanýlýr.Mantýk devreleri dersinde yapabileceðimiz tüm mekanizmalarda kullanabiliriz
