...
/*C Dili Ön Ýþlemci Kodlarý:
	Bir C programýnda simgesel sabitler, makro fonksiyonlar veya programýn koþullu derlenmesi istenirse bu ön iþlemci kodlarý kullanýlýr. Ön iþlemci komutlarý C program kodunun 
...
satýr sonuna '\' karakteri konulur ve alt satýrdan ön iþlemci kodu devam eder. Bu derste 12 adet ANCI C deki ön iþlemci kodlarýný inceleyeceðiz.
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
